...
print('Real mostrando unicamente 2 cifras decimales')
print("%.2f" % real)
...
for value in list_1:
    print("Values from List_1", value)
...
for value in tupla_num:
    print("Values from tupla_3", value)
...
while i < len(tupla):
    elemento = tupla[i]
    print("Element from tupla: ",elemento)  # Cuerpo del bucle "for".
    i += 1"""
